...
//     Main File of MorseCode program
// </copyright>
//-----------------------------------------------------------------------
namespace MorseCode
{
    ...
    {
        /// <summary>
        /// Dictionary of english translated into Morse Code
        /// </summary>
        private static readonly Dictionary<char, string> EnglishToMorse = new Dictionary<char, string>()
        {
            { ' ', " " },
            { 'A', ".-" },
            { 'B', "-..." },
        ...
        /// Main Function
        /// </summary>
        /// <param name="args">Arguments for the main class</param>
        ...
        /// <summary>
        /// Translate any given string into its Morse Code
        /// </summary>
        /// <param name="input">The English string turning into Morse Code</param>
        /// <returns>Output of string in morse code</returns>
